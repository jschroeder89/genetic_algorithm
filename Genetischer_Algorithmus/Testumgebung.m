...
n_methoden = numfun_s+numfun_cr+numfun_r;
...
for s=1:1:numfun_s
    ...
    for c=1:1:numfun_cr
        ...
        for r=1:1:numfun_r
            ...
            idx = idx+1;
            Methodenstring = strcat('sep: ', fun_sep(s), ' + cro: ', fun_cro(c), ' +  rek: ', fun_rek(r));
            %clc;
            ...
            it_sum = zeros(1,Spalten_it-1);
             ...
             for i=1:1:Max_It
                ...
                [loesung,Best_Counter,accuracy] = GeneticAlgorithm(g_max, @fRosenbrock, xmin, xmax, ymin, ymax, popsize, fun_sep(s), fun_cro(c), fun_rek(r), cro_w, mut_w, opt, dopt);
                ...
                [loesung,Best_Counter,accuracy] = GeneticAlgorithm(g_max, @fSchwefel, xmin, xmax, ymin, ymax, popsize, fun_sep(s), fun_cro(c), fun_rek(r), cro_w, mut_w, opt, dopt);
                ...
                [loesung,Best_Counter,accuracy] = GeneticAlgorithm(g_max, @fShekelsFuchsbauten, xmin, xmax, ymin, ymax, popsize, fun_sep(s), fun_cro(c), fun_rek(r), cro_w, mut_w, opt, dopt);
                ...
                [loesung,Best_Counter,accuracy] = GeneticAlgorithm(g_max, @fRastrigins, xmin, xmax, ymin, ymax, popsize, fun_sep(s), fun_cro(c), fun_rek(r), cro_w, mut_w, opt, dopt);
                ...
                [loesung,Best_Counter,accuracy] = GeneticAlgorithm(g_max, @fBaecksTreppenfunktion, xmin, xmax, ymin, ymax, popsize, fun_sep(s), fun_cro(c), fun_rek(r), cro_w, mut_w, opt, dopt);
                ...
                [loesung,Best_Counter,accuracy] = GeneticAlgorithm(g_max, @fGriewangks, xmin, xmax, ymin, ymax, popsize, fun_sep(s), fun_cro(c), fun_rek(r), cro_w, mut_w, opt, dopt);
                ...
                [loesung,Best_Counter,accuracy] = GeneticAlgorithm(g_max, @fAckleysFunktion, xmin, xmax, ymin, ymax, popsize, fun_sep(s), fun_cro(c), fun_rek(r), cro_w, mut_w, opt, dopt);
                ...
                [loesung,Best_Counter,accuracy] = GeneticAlgorithm(g_max, @fTreppenfunktion, xmin, xmax, ymin, ymax, popsize, fun_sep(s), fun_cro(c), fun_rek(r), cro_w, mut_w, opt, dopt);
